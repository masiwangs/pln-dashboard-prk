<template>
  <div>
    ...
    <div class="mb-5">
      <skki-navbar active="rab-material" :has-permission="hasPermission"/>
...
export default {
  ...
  methods: {
    getData() {
      this.$axios.get(`/v1/skki/${this.id}/material`)
        .then(res => {
    ...
    updateSave() {
      ...
      this.$axios.post(`/v1/prk/${this.edit_data.prk_id}/material/${this.edit_data.id}`, data)
        .then(res => {
          this.getData()
    ...
    deleteSave() {
      ...
      this.disabled = true;
      this.$axios.delete(`/v1/prk/${this.edit_data.prk_id}/material/${this.edit_data.id}`)
        .then(res => {
          this.getData()
