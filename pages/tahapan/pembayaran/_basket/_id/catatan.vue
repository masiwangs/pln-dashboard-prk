<template>
  <div>
    ...
    <div class="mb-5">
      <pembayaran-navbar active="catatan" :has-permission="hasPermission"/>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.$axios.get(`/v1/pembayaran/${this.id}/catatan`)
        .then(res => {
    ...
    createSave() {
      ...
      this.$axios.post(`/v1/pembayaran/${this.id}/catatan`, data)
        .then(res => {
